...
{
    const qreal lonPerMeter = Conversion::degreesLonPerMeter(this->latitude());
    const qreal latPerMeter = Conversion::degreesLatPerMeter(this->latitude());
...
{
    return Conversion::lla2enu(pos.latitude(),
                                pos.longitude(),
                                pos.altitude(),
                                refPos.latitude(),
                                refPos.longitude(),
...
{
    Position cPos = Conversion::enu2lla(enu,
                                                      refPos.latitude(),
                                                      refPos.longitude(),
                                                      refPos.altitude());
    return cPos;
