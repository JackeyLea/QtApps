...
MapTileObject::MapTileObject(quint16 tileSize)
{
...
QRectF MapTileObject::boundingRect() const
{
...
void MapTileObject::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    Q_UNUSED(option)
    Q_UNUSED(widget)
...
quint16 MapTileObject::tileSize() const
{
    return _tileSize;
}

void MapTileObject::setTileSize(quint16 tileSize)
{
...
void MapTileObject::setTile(quint32 x, quint32 y, quint8 z, bool force)
{
...
QSharedPointer<MapTileSource> MapTileObject::tileSource() const
{
    return _tileSource;
}

void MapTileObject::setTileSource(QSharedPointer<MapTileSource> nSource)
{
...
void MapTileObject::handleTileRetrieved(quint32 x, quint32 y, quint8 z)
{
...
void MapTileObject::handleTileInvalidation()
{
