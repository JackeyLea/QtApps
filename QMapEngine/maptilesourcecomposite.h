#ifndef MAPTILESOURCECOMPOSITE_H
#define MAPTILESOURCECOMPOSITE_H
...
class MapTileSourceComposite : public MapTileSource
{
    Q_OBJECT
public:
    explicit MapTileSourceComposite();
    virtual ~MapTileSourceComposite();
...
#endif // MAPTILESOURCECOMPOSITE_H
